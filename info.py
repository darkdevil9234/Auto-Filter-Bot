...
# Channels
INDEX_CHANNELS = [int(index_channels) if index_channels.startswith("-") else index_channels for index_channels in environ.get('INDEX_CHANNELS', '-1001782414786').split()]
...
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1001919010755') #bot log channel -1005293546253
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1001502366282') #support group id ex:  -1002936246860
...
URL = environ.get("URL", "https://premiumbot1-58cf73d038f8.herokuapp.com/") #if heroku then paste the app link here ex: https://heroku......./
if len(URL) == 0:
